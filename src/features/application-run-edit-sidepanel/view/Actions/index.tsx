...
export default function Actions() {
  const { isSubmitting, hasChanges } = useApplicationRunEditModel();
  ...
  const handleClickSubmit = () => {
    emit('#application-run-edit-sidepanel/form-submit', null);
  };

  const handleClickCancel = () => {
    emit('#application-run-edit-sidepanel/sidepanel-close', null);
  };
