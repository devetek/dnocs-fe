...
export const [FilterModelProvider, useFilterModel] = buildSelector(
  ...
  const qs = useSearch({
    from: '/_with-app-layout/teams/$id/',
  });
  ...
  useSubscribe('@team-members/filters/view-mode--change', (newViewMode) => {
    updateQs('viewMode', newViewMode !== 'auto' ? newViewMode : undefined);
  });

  useSubscribe('@team-members/filters/pagination--set', (newPage) => {
